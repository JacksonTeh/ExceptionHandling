...
void test_divide_given_5_and_2_should_get_2(void)
{
	CEXCEPTION_T err;
...
void test_divide_given_13_and_0_should_get_2(void)
{
	CEXCEPTION_T err;			//need to define this if you want to printf error
	Try
	{
...
void test_doSomethingWhichGeneratesNoException_given_7_should_not_throw_exception(void)
{
	CEXCEPTION_T err;
	...
	{
		TEST_FAIL_MESSAGE("Should NOT generate exception.");
	}
}

void test_doSomethingWhichGeneratesNoException_given_7_should_throw_an_exception(void)
{
	CEXCEPTION_T err;
...
void test_y_should_throw_an_exception(void)
{
	CEXCEPTION_T err;
